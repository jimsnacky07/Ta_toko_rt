    ...
    public function run(): void
    {
        ...
        $products = [
            [
                ...
                'ukuran' => 'S, M, L, XL',
                'deskripsi_ukuran' => 'S: Lingkar dada 96cm, M: Lingkar dada 100cm, L: Lingkar dada 104cm, XL: Lingkar dada 108cm',
        ...
        DB::table('products')->insert([
            ...
            'image' => 'images/baju kemeja cowok 4.jpg',
            'price' => 180000,
            'deskripsi' => 'Kemeja workshirt lengan pendek yang praktis dan stylish untuk aktivitas sehari-hari.',
            'bahan' => 'Cotton Twill',
            'kategory' => 'Kemeja',
            'motif' => 'Polos',
            'dikirim_dari' => 'Jakarta',
            'deskripsi_ukuran' => 'S: Lingkar dada 95cm, M: Lingkar dada 99cm, L: Lingkar dada 103cm',
            'fabric_type' => 'Cotton Twill',
            'color' => 'Abu-abu',
            'size' => 'S,M,L',
            'description' => 'Workshirt kasual untuk aktivitas sehari-hari',
            'is_custom' => false,
            'created_at' => $now,
            'updated_at' => $now
        ]);
        ...
        DB::table('products')->insert([
            'name' => 'Kemeja Cowok Abu-Abu',
            'image' => 'images/baju kemeja cowok 5.jpg',
            'price' => 100000,
            'deskripsi' => 'Kemeja cowok warna abu-abu yang elegan dan serbaguna.',
            'bahan' => 'Cotton',
            'kategory' => 'Kemeja',
            'motif' => 'Polos',
            'dikirim_dari' => 'Jakarta',
            'deskripsi_ukuran' => 'S: Lingkar dada 94cm, M: Lingkar dada 98cm, L: Lingkar dada 102cm',
            'fabric_type' => 'Cotton',
            'color' => 'Abu-abu Muda',
            'size' => 'S,M,L',
            'description' => 'Kemeja formal warna abu-abu yang elegan',
        ...
        DB::table('products')->insert([
            'name' => 'Kemeja Cowok Navy',
            'image' => 'images/kemeja cowok.jpg',
            'price' => 100000,
            'deskripsi' => 'Kemeja cowok warna navy yang klasik dan mudah dipadukan.',
            'bahan' => 'Cotton',
            'kategory' => 'Kemeja',
            'motif' => 'Polos',
            'dikirim_dari' => 'Jakarta',
            ...
            'color' => 'Navy',
            'size' => 'S,M,L',
            'description' => 'Kemeja warna navy yang klasik',
            'is_custom' => false,
            'created_at' => $now,
            'updated_at' => $now
        ]);
        ...
        DB::table('products')->insert([
            ...
            'image' => 'images/rok 4.jpg',
            'price' => 160000,
            'deskripsi' => 'Rok shimmer dengan warna ungu yang elegan. Cocok untuk acara pesta atau formal.',
            'bahan' => 'Shimmer Fabric',
            'kategory' => 'Rok',
            'motif' => 'Shimmer',
            'dikirim_dari' => 'Jakarta',
            'deskripsi_ukuran' => 'S: Pinggang 62cm, M: Pinggang 66cm, L: Pinggang 70cm',
            'fabric_type' => 'Shimmer',
            'color' => 'Ungu',
            'size' => 'S,M,L',
            'description' => 'Rok shimmer elegan untuk acara formal',
        ...
        DB::table('products')->insert([
            ...
            'image' => 'images/rok 6.jpg',
            'price' => 120000,
            'deskripsi' => 'Rok shimmer warna beige yang memberikan kesan soft dan elegan.',
            'bahan' => 'Shimmer Fabric',
            'kategory' => 'Rok',
            'motif' => 'Shimmer',
            'dikirim_dari' => 'Jakarta',
            'deskripsi_ukuran' => 'S: Pinggang 60cm, M: Pinggang 64cm, L: Pinggang 68cm',
            'fabric_type' => 'Shimmer',
            'color' => 'Beige',
            'size' => 'S,M,L',
            'description' => 'Rok shimmer warna soft untuk penampilan elegan',
        ...
        DB::table('products')->insert([
            ...
            'image' => 'images/rok 5 (1).jpg',
            'price' => 198000,
            'deskripsi' => 'Rok brukat dengan warna maron yang memberikan kesan klasik dan elegan.',
            'bahan' => 'Brukat Premium',
            'kategory' => 'Rok',
            'motif' => 'Brukat',
            'dikirim_dari' => 'Jakarta',
            'deskripsi_ukuran' => 'S: Pinggang 61cm, M: Pinggang 65cm, L: Pinggang 69cm',
            'fabric_type' => 'Brukat',
            'color' => 'Maron',
            'size' => 'S,M,L',
            'description' => 'Rok brukat premium untuk acara formal',
        ...
        DB::table('products')->insert([
            ...
            'image' => 'images/rok 3.jpg',
            'price' => 180000,
            'deskripsi' => 'Rok dengan desain susun ruffel yang feminin dan trendy.',
            'bahan' => 'Chiffon',
            'kategory' => 'Rok',
            'motif' => 'Ruffel',
            'dikirim_dari' => 'Jakarta',
        ...
        // Celana Formal Coklat
        DB::table('products')->insert([
            'name' => 'Celana Formal Coklat',
            'image' => 'images/celana 1.jpg',
            'price' => 170000,
            'deskripsi' => 'Celana formal warna coklat yang cocok untuk acara resmi dan kantor.',
            'bahan' => 'Wool Blend',
            'kategory' => 'Celana',
            'motif' => 'Polos',
            'dikirim_dari' => 'Jakarta',
            'deskripsi_ukuran' => 'S: Lingkar pinggang 76cm, M: Lingkar pinggang 80cm, L: Lingkar pinggang 84cm',
            'fabric_type' => 'Wool Blend',
            'color' => 'Coklat',
            'size' => 'S,M,L',
            'description' => 'Celana formal untuk penampilan profesional',
        ...
        DB::table('products')->insert([
            ...
            'image' => 'images/celana 2.jpg',
            'price' => 160000,
            'deskripsi' => 'Celana casual warna cream yang nyaman untuk aktivitas sehari-hari.',
            'bahan' => 'Cotton Twill',
            'kategory' => 'Celana',
            'motif' => 'Polos',
            'dikirim_dari' => 'Jakarta',
        ...
        DB::table('products')->insert([
            ...
            'image' => 'images/jas.jpg',
            'price' => 310000,
            'deskripsi' => 'Jas wanita warna navy yang elegan untuk acara formal dan bisnis.',
            'bahan' => 'Wool Premium',
            'kategory' => 'Jas',
            'motif' => 'Polos',
            'dikirim_dari' => 'Jakarta',
            'deskripsi_ukuran' => 'S: Lingkar dada 88cm, M: Lingkar dada 92cm, L: Lingkar dada 96cm',
            'fabric_type' => 'Wool',
            'color' => 'Navy',
            'size' => 'S,M,L',
            'description' => 'Jas formal wanita untuk penampilan profesional',
        ...
        // Jas Wanita Abu-Abu Elegan
        // Jas Wanita Abu-Abu Elegan
        DB::table('products')->insert([
            'name' => 'Jas Wanita Abu-Abu Elegan',
            'image' => 'images/jas cewek 2.jpg',
            'price' => 350000,
            'deskripsi' => 'Jas wanita abu-abu dengan desain elegan dan modern.',
            'bahan' => 'Wool Premium',
            'kategory' => 'Jas',
            'motif' => 'Polos',
            'dikirim_dari' => 'Jakarta',
            ...
            'color' => 'Abu-abu',
            'size' => 'S,M,L',
            'description' => 'Jas wanita elegan dengan desain modern',
            'is_custom' => false,
            'created_at' => $now,
            'updated_at' => $now
        ]);
            ...
            [
                ...
                'ukuran' => 'S, M, L, XL',
                'deskripsi_ukuran' => 'S: Lingkar dada 88cm, M: Lingkar dada 92cm, L: Lingkar dada 96cm, XL: Lingkar dada 100cm',
                'deskripsi' => 'Blouse wanita dengan desain elegant dan feminin. Berbahan chiffon premium yang ringan dan nyaman. Cocok untuk ke kantor atau acara semi formal. Dilengkapi dengan detail kancing mutiara.',
                'description' => 'Blouse elegant berbahan chiffon untuk tampilan profesional',
                'colors' => 'Putih,Pink,Navy',
                'sizes' => 'S,M,L,XL',
                'fabric_type' => 'Chiffon Premium',
            ...
            [
                'name' => 'Blazer Wanita Professional',
                'image' => 'images/jas cewek 2.jpg',
                'price' => 280000,
                'kategory' => 'Blazer',
                ...
                'ukuran' => 'S, M, L, XL',
                'deskripsi_ukuran' => 'S: Lingkar dada 88cm, M: Lingkar dada 92cm, L: Lingkar dada 96cm, XL: Lingkar dada 100cm',
                'deskripsi' => 'Blazer wanita dengan cutting professional yang memberikan kesan authoritative dan confident. Berbahan polyester premium dengan lining yang halus. Cocok untuk meeting, presentasi, atau acara bisnis. Dilengkapi dengan 2 kancing depan.',
                'description' => 'Blazer professional untuk tampilan bisnis yang confident',
                'colors' => 'Hitam,Navy,Abu-abu',
                'sizes' => 'S,M,L,XL',
                'fabric_type' => 'Polyester Premium',
                'is_preorder' => false,
                'created_at' => $now,
                'updated_at' => $now
            ],
            [
                ...
                'ukuran' => 'M, L, XL, XXL',
                'deskripsi_ukuran' => 'M: Lingkar dada 98cm, L: Lingkar dada 102cm, XL: Lingkar dada 106cm, XXL: Lingkar dada 110cm',
                'deskripsi' => 'Kemeja batik dengan motif modern yang memadukan tradisi dan kontemporer. Berbahan katun batik asli dengan pewarnaan alami. Cocok untuk acara formal, kondangan, atau ke kantor. Motif eksklusif yang tidak pasaran.',
                'description' => 'Kemeja batik modern dengan motif eksklusif dan bahan premium',
                'colors' => 'Biru Batik,Coklat Batik',
                'sizes' => 'M,L,XL,XXL',
                'fabric_type' => 'Katun Batik',
                'is_preorder' => false,
